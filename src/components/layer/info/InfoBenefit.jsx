    ...
    <Styled.Wrapper>
      ...
      <div className="content-area">
        ...
        <p className="description">
          강아지는 특수 화물로 분류되기 때문에 강아지 단독으로 비행기를 탑승할 경우 체고에 따라 약 200-300만원의 비용이 발생합니다.
          하지만 출국하는 승객 편에 대리 수속으로 함께 나간다면 20-60만원의 비용만 있으면 된다고 합니다.
          이동비가 최대 1/10까지 줄어드는 것이죠.
          또한 봉사자 없이 아이들만 카고로 이동하게 되는 경우 이동봉사자와의 이동에 비해 4시간 이상 켄넬에 있는 시간이 길어져 아이들이 더욱 지치고 힘들어합니다.
        </p>
