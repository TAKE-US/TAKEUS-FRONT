        ...
        <section className="content-area">
          <article className="card">
            <div>
              ...
              <ul>
                ...
                <li className="card__list">
                  봉사자님의 e-ticket과 연락처를 보내주시면 단체에서 해당
                  항공편에 보낼 수 있는 강아지 자리가 남아있는지 확인하고
                  예약합니다
                </li>
                <li className="card__list">
                  항공사에 따라 1인 2~3마리까지 가능합니다
                </li>
                <li className="card__list">
          ...
          <article className="card">
            <div>
              ...
              <ul>
                <li className="card__list">
                  출국 할 강아지가 정해지면 단체의 안내를 끝으로 출국전까지
                  이동봉사자가 신경쓰셔야 할 부분은 없습니다
                </li>
                <li className="card__list">
                  건강검진 확인서, 예방접종관련 서류 등 진행에 필요한 서류는
                  단체에서 준비합니다.
                </li>
                <li className="card__list">
                  검역은 일반적으로 출국 전 검역소에 들러 검역 후 검역서류를
                  받습니다. 검역소에 제출한 강아지 건강증명서와 동물검역 증명서,
                  그리고 강아지 이동 목적과 여행자가 봉사자임을 설명하는 레터,
                  총 세 가지가 필수적으로 필요합니다.
                </li>
              </ul>
            </div>
          ...
          <article className="card">
            <div>
              ...
              <ul>
                <li className="card__list">
                  봉사자와 인천공항에서 만날 장소와 시간을 정하고 입양자와
                  이동봉사자가 서로를 알아볼 수 있도록 사진을 찍어 교환하기도
                  합니다.
                </li>
                <li className="card__list">
                  체크인은 일반적으로 단체의 담당자가 함께 동행하며 평소보다
                  30분정도의 시간이 더 걸릴 수 있습니다.
                </li>
                <li className="card__list">
                  강아지는 무게를 잰 후 대형 수화물 보내는곳으로 옮겨지며
                  이동봉사자는 티켓을 받은 후 단체로부터 서류를 챙겨
                  출국하시면됩니다.
                </li>
              </ul>
            </div>
          ...
          <article className="card">
            ...
            <div>
              ...
              <ul>
                <li className="card__list">
                  도착 후 수화물 찾는곳에 대상견이 먼저 나와있을 겁입니다. 본인
                  짐을 챙기신 후 대상견은 공항의 Poter service를 이용하여
                  이동하시면 됩니다.
                </li>
                <li className="card__list">
                  포터 서비스 비용은 입양자분이 지불합니다.
                </li>
                <li className="card__list">
                  마지막으로 세관에 준비 된 서류를 제출하시면 해외 이동봉사
                  완료입니다 :)
                </li>
              </ul>
            </div>
          ...
          <p className="last-desc">
            입국수속 시 강아지에 대해 묻는다면 이 강아지는 입양자가 기다리고
            있으며 이동봉사로 데려왔다고 하시면 됩니다.
            <br />
          ...
          <div className="inquiry">
            ...
            개인구조자에 따라 약간씩 차이가 있을 수 있습니다. <br />
            질문이나 자세한 사항은 대상견을 보호하고 있는 단체나 개인 구조자에게
            문의 부탁드립니다.
          </div>
        </section>
