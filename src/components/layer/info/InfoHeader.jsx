    ...
    <Styled.Wrapper>
      <section className="content-area">
        ...
        <p className="description">
          국내에서 입양이 잘 이루어지지 않는 믹스견 등의 아이들은 해외입양이
          이루어지곤 합니다. <br />
          운좋게 해외입양이 확정되어 안락사를 피하거나 보호소 생활에서 벗어난
          아이들은 먼 바다를 건너야 해요. <br />이 멀고도 긴 여정을 TAKEUS와
          TAKERS가 함께합니다 : )
        </p>
        <div className="qna-area">
          <img
            className="qna"
            src={Question1}
            alt="이동봉사 절차가 어떻게 되나요?"
          />
          <img
            className="qna right"
            src={Question2}
            alt="이동봉사를 할 때 신경 써야 하는 것은 어떤 것이 있나요?"
          />
          <img
            className="qna"
            src={Question3}
            alt="보호소/단체와는 어떻게 컨텍을 하나요?"
          />
          <img
            className="qna"
            src={Question4}
            alt="이동봉사는 왜 필요한 것인가요?"
          />
        </div>
