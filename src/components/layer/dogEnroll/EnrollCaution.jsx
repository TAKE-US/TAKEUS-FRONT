        ...
        <ol className="card__list">
          <Styled.List>
            ...
            <li className="content">
              대상견과 봉사자의 매칭이 성사되면 <span className="highlight">마이페이지-내가 올린 대상견 페이지</span>
              에서 <span className="highlight">매칭상태를 완료로 변경</span>하여 주세요. <br />
          ...
          <Styled.List>
            ...
            <li className="content">
              이미 봉사가 이루어진 대상견의 정보가 봉사자에게 노출 되는 것을 방지하기 위함이며 봉사자들의 혼란을
              방지하기 위한 조치입니다.
            </li>
          </Styled.List>
          <Styled.List>
            ...
            <li className="content">
              이동봉사 이외의 홍보 목적을 띈 게시물이나 허위 사실, 악의적인 의도가 포함된 게시물등의 경우 <br />
              <span className="highlight">
                경고없이 게시물이 삭제 될 수 있으며 서비스 이용 정지등의 조치가 이루어 질 수 있습니다.
              </span>
            </li>
          </Styled.List>
          <Styled.List>
